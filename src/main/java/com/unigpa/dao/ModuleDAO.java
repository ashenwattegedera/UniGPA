...
public class ModuleDAO {
    ...
    public List<Module> getModulesByUserId(long userId) {
        ...
        String sql = "SELECT * FROM modules WHERE user_id = ? ORDER BY academic_year DESC, semester DESC, module_code ASC";
    ...
    public void addModule(Module module) {
        String sql = "INSERT INTO modules (module_code, module_name, credits, grade, semester, academic_year, user_id) VALUES (?, ?, ?, ?, ?, ?, ?)";
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            stmt.setLong(7, module.getUserId());
    ...
    public void updateModule(Module module) {
        String sql = "UPDATE modules SET module_code=?, module_name=?, credits=?, grade=?, semester=?, academic_year=? WHERE id=? AND user_id=?";
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            stmt.setLong(8, module.getUserId());
    ...
    public void deleteModule(int id, long userId) {
